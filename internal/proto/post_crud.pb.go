...
var file_proto_post_crud_proto_rawDesc = []byte{
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x32, 0xe2, 0x02, 0x0a, 0x0f, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x6e,
...
var file_proto_post_crud_proto_depIdxs = []int32{
	...
	7, // 7: postcrud.PostInfoService.GetPostValues:input_type -> postcrud.GetPostValuesRequest
	2, // 8: postcrud.PostInfoService.AddPostValue:output_type -> postcrud.AddPostValueResponse
	4, // 9: postcrud.PostInfoService.RemovePostValue:output_type -> postcrud.RemovePostValueResponse
	6, // 10: postcrud.PostInfoService.UpdatePostValue:output_type -> postcrud.UpdatePostValueResponse
	8, // 11: postcrud.PostInfoService.GetPostValues:output_type -> postcrud.GetPostValuesResponse
